...
%spm('Defaults','fMRI');
spm_jobman('initcfg');
%select 50 volumes for first run 
a = spm_select('FPList', fullfile(data_path),'^CURE.*nii$');
anat = spm_select('FPList',fullfile(data_path), '^anat_CURE.*nii$');%

vx = repmat(voxelsize,1,3);
sm = repmat(smooth,1,3);


clear matlabbatch
%Run realign
matlabbatch{1}.spm.spatial.realign.estwrite.data = {cellstr(a)};
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.quality = 0.9;
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.sep = 4;
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.fwhm = 5;
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.rtm = numpasses;
...
matlabbatch{2}.spm.spatial.coreg.estwrite.ref = cellstr(anat);
...
matlabbatch{3}.spm.spatial.preproc.channel.vols = cellstr(anat);
matlabbatch{3}.spm.spatial.preproc.channel.biasreg = 0.001;
matlabbatch{3}.spm.spatial.preproc.channel.biasfwhm = 60;
matlabbatch{3}.spm.spatial.preproc.channel.write = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(1).tpm = {'./execute/tpm/TPM.nii,1'};
matlabbatch{3}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(1).native = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).tpm = {'./execute/tpm/TPM.nii,2'};
matlabbatch{3}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(2).native = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).tpm = {'./execute/tpm/TPM.nii,3'};
matlabbatch{3}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{3}.spm.spatial.preproc.tissue(3).native = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).tpm = {'./execute/tpm/TPM.nii,4'};
matlabbatch{3}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{3}.spm.spatial.preproc.tissue(4).native = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).tpm = {'./execute/tpm/TPM.nii,5'};
matlabbatch{3}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{3}.spm.spatial.preproc.tissue(5).native = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(6).tpm = {'./execute/tpm/TPM.nii,6'};
...
matlabbatch{4}.spm.util.defs.comp{1}.idbbvox.vox = vx;
matlabbatch{4}.spm.util.defs.comp{1}.idbbvox.bb = [-89 -125 -71
                                                   90 90 108];
matlabbatch{4}.spm.util.defs.out{1}.pull.fnames(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 1)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{1}, '.','rfiles'));
matlabbatch{4}.spm.util.defs.out{1}.pull.savedir.savesrc = 1;
...
matlabbatch{4}.spm.util.defs.out{1}.pull.prefix = '';
matlabbatch{5}.spm.spatial.smooth.data(1) = cfg_dep('Deformations: Warped Images', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','warped'));
matlabbatch{5}.spm.spatial.smooth.fwhm = sm;
